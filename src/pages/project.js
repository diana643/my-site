...
const imgs = [
  {
    ...
    title: "Toolbox",
    description:"Toolbox is a applications storage website which is designed by material design and developped by React"
  },
  {
    id: "2",
  ...
  },
  {
    ...
    description:"This is a internal salesforce tool for user checking their salesforce certification score, designed by lighting design"
  },
  {
    id: "4",
    src: require("../assets/pics/projects/stafing_cover.jpg"),
    title: "Stafing",
    description:"It's a mobile version of internal project managment tool on salesforce plateform "
  },
]
    ...
    <Fragment>
      ...
      <div className={classes.root}>
        ...
        <Grid container justify="space-between" spacing={4}>
          {imgs.map(img => (
            <Grid item xs={12} sm={6} md={4} key={img.id}>
              <ProjectCard src={img.src} title={img.title} description={img.description}/>
            </Grid>
          ))}
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={4}>
              <ProjectCard src={require('../assets/pics/projects/my_website.png')} title="Personal website" description="This is my personal website, design and develop by myself using Gatsby.js as the frameworks" />
            </Grid>
        </Grid>
      </div>
